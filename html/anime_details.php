    ...
    if (isset($_POST['movie_id'])) {
        ...
        try {
            ...
            if ($user) {
                ...
                $stmt = $conn->prepare(" INSERT INTO list (idu, id) VALUES (:user_id, :movie_id)");
            ...
            <div class="descp">
                ...
                <div class="movie-content">
                    <div class="movie-trailer">
                        ...
                        <div class="trailer">
                            <div class="save">
                                <button style="background-color: transparent;"  id="bookmark-btn" data-movie-id="<?php echo $movie['id']; ?>">
                            ...
                            <div>
                                <a href="watch_anime.php?id=<?php echo htmlspecialchars($movie["id"]); ?>" class="btn-trailer">
                                    Watch
                                </a>
                            </div>
                        </div>
